...
if GLiNERDetector:
    DEFAULT_DETECTORS.append(GLiNERDetector())
...
class Pipeline:
    ...
    def _run_detectors_sync(self, text: str, context: Optional[dict] = None) -> list:
    ...
    async def analyze(self, request: AnalysisRequest) -> AnalysisResult:
        ...
        context = {}
        if getattr(request, "custom_labels", None):
            context["custom_labels"] = request.custom_labels
