...
_TEMPLATES: Dict = {
    ...
    SensitivityCategory.HEALTH_INFO: [
        ...
        "patient test results and hospital admission details",
    ],
    SensitivityCategory.FINANCIAL_DATA: [
        "credit card bank account routing number",
        "salary income tax social security",
        "wire transfer transaction statement",
        "debit card number expiration date CVV",
        "investment portfolio brokerage account balance",
        "tax return filing information",
    ],
    SensitivityCategory.PERSONAL_INFO: [
        "my name is address phone number",
        "social security date of birth",
        "government identification number passport driver license",
        "home address email personal contact information",
    ],
    SensitivityCategory.SOURCE_CODE: [
        "function class import def return",
        "javascript python sql database",
    ],
    SensitivityCategory.SECRET_BUSINESS: [
        "acquisition agreement merger undisclosed valued crore million",
        "planned restructuring workforce reduction layoff job cuts",
        "confidential project launch undisclosed revenue figure",
        "trade secret proprietary strategy roadmap internal only",
        "quarterly performance financial results undisclosed",
        "Falcon project regional offices restructuring plan",
        "The acquisition agreement between companies valued at undisclosed amount",
        "merger announcement undisclosed valuation remains confidential",
    ],
}
