...
DEFAULT_THRESHOLDS = {
    ...
    SensitivityCategory.PERSONAL_INFO: 0.60,
    SensitivityCategory.SOURCE_CODE: 0.75,
    SensitivityCategory.SECRET_BUSINESS: 0.70,
}

DEFAULT_ACTIONS = {
    SensitivityCategory.CREDENTIALS: Action.BLOCK,
    SensitivityCategory.HEALTH_INFO: Action.BLOCK,
    SensitivityCategory.FINANCIAL_DATA: Action.BLOCK,
    SensitivityCategory.PERSONAL_INFO: Action.MASK,
    SensitivityCategory.SOURCE_CODE: Action.BLOCK,
    SensitivityCategory.SECRET_BUSINESS: Action.BLOCK,
